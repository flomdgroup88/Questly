    ...
    <div style={{ ...shellStyle, maxHeight: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <ErrorBoundary key={tab}>
          ...
          {tab === "social"    && <SocialScreen   challenges={challenges} sharedGoals={sharedGoals} onUpdateCh={handleUpdateCh} onUpdateSg={handleUpdateSg} onDeleteCh={handleDeleteCh} onDeleteSg={handleDeleteSg} onCreateCh={handleCreateCh} onCreateSg={handleCreateSg} nickname={nickname} userAvatar={userAvatar} xp={xp} tasks={tasks} friends={friends} userKey={userKey} onAddFriend={handleAddFriend} onRemoveFriend={handleRemoveFriend} />}
